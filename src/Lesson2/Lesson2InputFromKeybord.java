...
//чтоб подключить Scanner импортировали библиотеку
public class Lesson2InputFromKeybord {
    public static void main(String[] args) {
        //КАК ВВОДИТЬ что-то С КЛАВИАТУРЫ???

        //это стандартный шаблон для ввода с клавиатуры
        //создаем объект класса Scanner (он системный, написан кем-то...)
        //чтоб его подключить мы ранее импортировали библиотеку import java.util.Scanner;
        //мы создали объект input
        //далее мі в переменную типа Integer мы присваиваем из этого input-а
        //System.in - обращение к клавиатуре
        //и это присваивается целое значение
...
после чего самостоятельно выполнить парсинг (буквально - "разбор", но по смыслу - переформатирование,
